...
<p>
    ...
    <p>
        <b>Time Commitment.</b> The open-ended nature of this competition means that participants could spend a relatively small amount of time, like a weekend, putting together a submission. However, participants might also devote significant time to their project over the duration of the contest (see Important Dates below). Overall, we anticipate that the most successful teams will spend at least 3-5 hours per week on the project for the duration of the contest.
    </p>
    <p>
