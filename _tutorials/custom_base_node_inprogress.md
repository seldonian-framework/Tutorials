...
<li>These five native Python math functions: <code class='codesnippet'>min(),max(),abs(),exp(),log()</code> </li>
...
<li>Add "PREC" to the "classification" subdictionary in the <code class='codesnippet'>measure_functions_dict</code> here: <a href="https://github.com/seldonian-toolkit/Engine/blob/main/seldonian/parse_tree/operators.py#L74">https://github.com/seldonian-toolkit/Engine/blob/main/seldonian/parse_tree/operators.py#L74</a></li>
<li><p>Add the following key-value pair to the <code class='codesnippet'>measure_function_mapper</code> dictionary at the bottom of this module: <a href="https://github.com/seldonian-toolkit/Engine/blob/main/seldonian/models/objectives.py">https://github.com/seldonian-toolkit/Engine/blob/main/seldonian/models/objectives.py</a>:</p>
...
<p>
This points to a function <code class='codesnippet'>Precision()</code> which we will implement below to calculate the mean precision value over a set of points, returning a float.
</p>
 </li>

 <li><p>Add the following key-value pair to the <code class='codesnippet'>measure_function_vector_mapper</code> dictionary at the bottom of this module: <a href="https://github.com/seldonian-toolkit/Engine/blob/main/seldonian/models/objectives.py">https://github.com/seldonian-toolkit/Engine/blob/main/seldonian/models/objectives.py</a>:</p>
...
This points to a function <code class='codesnippet'>vector_Precision()</code> which we will implement shortly to calculate the precision values on each point in a set of points, returning a vector.
 ...
 <li>Add a new function <code class='codesnippet'>Precision()</code> to the same file (<code>objectives.py</code>) that calculates the precision on a set of points and returns a float. Note that we will use the existing functions in this file called <code class='codesnippet'>True_Positive_Rate()</code> and <code class='codesnippet'>False_Positive_Rate()</code> in our implementation.
