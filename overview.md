...
<div class="container p-3 my-5 border" style="background-color: #f3f4fc;">
    ...
    <ul>
        ...
        <li>The designer of the algorithm should make their interface as simple to use as possible. This is important because already machine learning algorithms are used by people, even children, who are not experts in machine learning.</li>
    </ul>
</div>
